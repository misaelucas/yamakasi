    ...
    <Router>
      <main className="font-mono tracking-tight min-h-screen dark bg-zinc-950 text-zinc-100">
        <header className="flex items-center justify-between px-6 py-4 bg-zinc-950 border-b border-zinc-800">
          <Link
            to="/"
            className="text-white text-xl font-semibold flex items-center space-x-1 hover:text-pink-500 transition"
          >
          ...
          <nav className="flex gap-6 text-sm text-zinc-300">
            ...
            <Link to="/flashcards" className="hover:text-pink-500 transition">
              Flashcards
            </Link>
            <Link to="/notes" className="hover:text-pink-500 transition">
              Notes
            </Link>
            <Link to="/infographics" className="hover:text-pink-500 transition">
              Infographics
            </Link>
          </nav>
        </header>
